...
class TestUnrootedRadial(unittest.TestCase):
    ...
    def test_coords(self):
        t = ToyModel.from_tree(self.tree)
['y6', 'y7', 117.21642391143635, 301.99423347326797, 74.068217341096869, 368.43664502236788], ['y7', 'y17', 178.78464125253325, 252.13727411816777, 117.21642391143635, 301.99423347326797]]}4
        edge_exp = pd.DataFrame({'0': ['0', 'y11', 408.3850804246091, 240.10442497874831, 
                                        474.82749197370902, 283.25263154908782],
                                 '1': ['1', 'y16', 257.89956082792412, 247.99103687506513, 
                                        286.29072143348549, 321.95253890257857],
                                 '2': ['2', 'y14', 375.00926942577706, 153.15746472040379, 
                                        436.57748676687396, 103.30050536530359],                           
                                 '3': ['3', 'y11', 408.3850804246091, 240.10442497874831, 
                                        487.5, 235.95818773564568],                             
                                 '4': ['4', 'y6', 74.068217341096869, 368.43664502236788, 
                                        12.499999999999979, 418.29360437746811],           
                                 '5': ['5', 'y14', 375.00926942577706, 153.15746472040379,
                                        395.51381813502167, 76.633447151232261],                                 
                                 '6': ['6', 'y6', 74.068217341096869, 368.43664502236788, 
                                        53.563668631852295, 444.9606625915394], 
                                 '7': ['7', 'y2', 79.070722542332845, 129.00083943597397, 
                                        50.679561936771449, 55.039337408460526],                                 
                                 '8':['8', 'y2', 79.070722542332845, 129.00083943597397, 
                                        12.628310993232901, 85.85263286563449], 
                                 '9': ['9', 'y7', 117.21642391143635, 301.99423347326797, 
                                        38.10150433604548, 306.1404707163706],                                 
                                 'y11': ['y11', 'y15', 331.86106285543758, 219.59987626950374, 
                                        408.3850804246091, 240.10442497874831],
                                 'y14': ['y14', 'y15', 331.86106285543758, 219.59987626950374, 
                                        375.00926942577706, 153.15746472040379], 
                                 'y15': ['y15', 'y16', 257.89956082792412, 247.99103687506513, 
                                        331.86106285543758, 219.59987626950374],
                                 'y16': ['y16', 'y17', 178.78464125253325, 252.13727411816777,
                                        257.89956082792412, 247.99103687506513],
                                 'y17': ['y17', 'y18', 128.92768189743305, 190.56905677707087,
                                        178.78464125253325, 252.13727411816777],
                                 'y18': ['y18',153.134, 186.709, 'y2', 'y17', False],
                                'y2': ['y2', 'y18', 128.92768189743305, 190.56905677707087, 79.070722542332845, 129.00083943597397],                                 'y6': ['y6',100.549, 395.421, '4', '6', False],
                                'y7': ['y7',146.353, 316.086, '9', 'y6', False]},
                               index=['x', 'y', 'child0', 'child1', 'is_tip']).T
	    node_exp = pd.DataFrame({'0':['0', 474.82749197370902, 283.25263154908782], 
