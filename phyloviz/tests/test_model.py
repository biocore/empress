...
class TestModel(unittest.TestCase):
  ...
  def test_select_category(self):
    self.tree.center_tree()
    self.tree.edge_metadata['node_is_visible'] = [True, True, False, False, True, True]
    select_exp = pd.DataFrame(
      ...
      index=['px','py','x','y']).T
    select_res = self.tree.select_category(['px', 'py', 'x', 'y'], 'node_is_visible')
  ...
  def test_select_edge_category(self):
    ...
    select_exp = pd.DataFrame(
      {
        0: [(332.627 - 750), (450 - 450), (37.5 - 750), (154.873 - 450), 'FFFFFF'],
        1: [(332.627 - 750), (450 - 450), (37.5 - 750), (745.127 - 450), 'FFFFFF'],
        2: [(1167.37 - 750), (450 - 450), (1462.5 - 750), (745.127 - 450), 'FFFFFF'],
        3: [(1167.37 - 750), (450 - 450), (1462.5 - 750), (154.873 - 450), 'FFFFFF'],
        4: [(750 - 750), (450 - 450), (332.627 - 750), (450 - 450), 'FFFFFF'],
        5: [(750 - 750), (450 - 450), (1167.37 - 750), (450 - 450), 'FFFFFF']
      },
    ...
    select_exp[['px','py','x','y']] = select_exp[['px','py','x','y']].astype(int)
    select_res[['px','py','x','y']] = select_res[['px','py','x','y']].astype(int)
    assert_frame_equal(select_exp, select_res)
  ...
  def test_select_node_category(self):
    ...
    select_exp[['x','y', 'size']] = select_exp[['x','y', 'size']].astype(int)
    select_res[['x','y', 'size']] = select_res[['x','y', 'size']].astype(int)
    assert_frame_equal(select_exp, select_res)
  ...
  def test_update_edge_category(self):
    ...
    update_equal_exp = pd.DataFrame(
      {
        0: [(332.627 - 750), (450 - 450), (37.5 - 750), (154.873 - 450), '000000'],
        1: [(332.627 - 750), (450 - 450), (37.5 - 750), (745.127 - 450), 'FFFFFF'],
        2: [(1167.37 - 750), (450 - 450), (1462.5 - 750), (745.127 - 450), 'FFFFFF'],
        3: [(1167.37 - 750), (450 - 450), (1462.5 - 750), (154.873 - 450), 'FFFFFF'],
        4: [(750 - 750), (450 - 450), (332.627 - 750), (450 - 450), 'FFFFFF'],
      ...
      index=['px','py','x','y', 'branch_color']).T
    update_equal_res = self.tree.update_edge_category('species', 'branch_color', equal='a1' )
    update_equal_exp = update_equal_exp[['px','py','x','y', 'branch_color']]
    update_equal_res = update_equal_res[['px','py','x','y', 'branch_color']]
    update_equal_exp[['px','py','x','y']] = update_equal_exp[['px','py','x','y']].astype(int)
    update_equal_res[['px','py','x','y']] = update_equal_res[['px','py','x','y']].astype(int)
    ...
    update_less_exp = pd.DataFrame(
      {
        ...
        2: [(1167.37 - 750), (450 - 450), (1462.5 - 750), (745.127 - 450), 'FFFFFF'],
        3: [(1167.37 - 750), (450 - 450), (1462.5 - 750), (154.873 - 450), 'FFFFFF'],
        4: [(750 - 750), (450 - 450), (332.627 - 750), (450 - 450), '111111'],
        5: [(750 - 750), (450 - 450), (1167.37 - 750), (450 - 450), '111111']
      },
      index=['px','py','x','y', 'branch_color']).T
    update_less_res = self.tree.update_edge_category('time', 'branch_color', new_value='111111', lower=10 )
    update_less_exp = update_less_exp[['px','py','x','y', 'branch_color']]
    update_less_res = update_less_res[['px','py','x','y', 'branch_color']]
    update_less_exp[['px','py','x','y']] = update_less_exp[['px','py','x','y']].astype(int)
    update_less_res[['px','py','x','y']] = update_less_res[['px','py','x','y']].astype(int)
    ...
    update_greater_exp = pd.DataFrame(
      {
        ...
        2: [(1167.37 - 750), (450 - 450), (1462.5 - 750), (745.127 - 450), 'FFFFFF'],
        3: [(1167.37 - 750), (450 - 450), (1462.5 - 750), (154.873 - 450), 'FFFFFF'],
        4: [(750 - 750), (450 - 450), (332.627 - 750), (450 - 450), '121212'],
        5: [(750 - 750), (450 - 450), (1167.37 - 750), (450 - 450), '111111']
      },
      index=['px','py','x','y', 'branch_color']).T
    update_greater_res = self.tree.update_edge_category('time', 'branch_color', new_value='121212', upper=12 )
    update_greater_exp = update_greater_exp[['px','py','x','y', 'branch_color']]
    update_greater_res = update_greater_res[['px','py','x','y', 'branch_color']]
    update_greater_exp[['px','py','x','y']] = update_greater_exp[['px','py','x','y']].astype(int)
    update_greater_res[['px','py','x','y']] = update_greater_res[['px','py','x','y']].astype(int)
