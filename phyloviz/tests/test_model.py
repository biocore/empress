...
class TestModel(unittest.TestCase):
    ...
    def test_center(self):
        center_exp = pd.DataFrame({0: [(332.627 - 750), (450 - 450),
                                       (37.5 - 750), (154.873 - 450)],
                                   1: [(332.627 - 750), (450 - 450),
                                       (37.5 - 750), (745.127 - 450)],
                                   2: [(1167.37 - 750), (450 - 450),
                                       (1462.5 - 750), (745.127 - 450)],
                                   3: [(1167.37 - 750), (450 - 450),
                                       (1462.5 - 750), (154.873 - 450)],
                                   4: [(750 - 750), (450 - 450),
                                       (332.627 - 750), (450 - 450)],
                                   5: [(750 - 750), (450 - 450),
                                       (1167.37 - 750), (450 - 450)]},
    ...
    def test_select_category(self):
        ...
        select_exp = pd.DataFrame({0: [(332.627 - 750), (450 - 450),
                                       (37.5 - 750), (154.873 - 450)],
                                   1: [(332.627 - 750), (450 - 450),
                                       (37.5 - 750), (745.127 - 450)],
                                   4: [(750 - 750), (450 - 450),
