...
@click.option('--internal_metadata', help = 'The file that contains internal node metadata')
@click.option('--leaf_metadata', help = 'The file that contains tip node metadata')
def build_tree(tree_file, tree_format, internal_metadata, leaf_metadata):
    controller.build_tree(tree_file, tree_format, internal_metadata, leaf_metadata)
    print("done")
    return
...
if __name__ == '__main__':
    ...
    #controller.build_tree(tree_file, tree_format, internal_metadata_file, leaf_metadata_file)
    build_tree()
