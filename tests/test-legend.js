require(["jquery", "chroma", "Legend"], function (
    $,
    chroma,
    Legend
) {
    $(document).ready(function () {
        ...
        test("On initialization, clear() isn't called", function () {
            ...
            // Legend)
            var funkyP = this.containerEle.appendChild(document.createElement("p"));
        ...
        test("addCategoricalKey", function () {
            var legend = new Legend(this.containerEle);
            var colorInfo = {"Thing 1": "#ff0000", "Thing 2": "#00ff00", "Thing 3": "#0000ff", "Thing 4": "#ffffff", "Thing 5": "#000000"};
            ...
            $(tbl).find("tr").each(function(i, tr) {
                ...
                equal(chroma(shownColor).hex(), chroma(colorInfo[expectedKey]).hex());
        ...
        test("clear", function () {
            ...
            var wackyDiv = this.containerEle.appendChild(document.createElement("div"));
            wackyDiv.innerText = "I'm here to test that clear removes all children";
            legend.clear();
