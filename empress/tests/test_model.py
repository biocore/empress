...
class TestModel(unittest.TestCase):
    ...
    def test_select_node_category(self):
        ...
        select_exp = pd.DataFrame(
            {
                0: [(37.5 - self.RT_X), (154.873 - self.RT_Y), '000000', 1],
                1: [(37.5 - self.RT_X), (745.127 - self.RT_Y), '000000', 1],
                2: [(1462.5 - self.RT_X), (745.127 - self.RT_Y), '000000', 1],
                3: [(1462.5 - self.RT_X), (154.873 - self.RT_Y), '000000', 1],
                4: [(332.627 - self.RT_X), (self.RT_Y - self.RT_Y), '000000', 1],
                5: [(1167.37 - self.RT_X), (self.RT_Y - self.RT_Y), '000000', 1]
            },
